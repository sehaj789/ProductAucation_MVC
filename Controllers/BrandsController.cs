...
namespace ProductAucation_MVC.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public BrandsController(ProductAucationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand_Name,Description")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand_Name,Description")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
